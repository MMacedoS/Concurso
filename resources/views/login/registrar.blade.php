                        ...
                        <div class="container">
                            ...
                            <form action="{{ route('registro.store'); }}" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-4 initial">
                                            <label for=""><span>*</span>E-mail
                                                <input type="email" class="form-input" required name="email" id="email" oninvalid="this.setCustomValidity('Por favor, entre com um nome e sobrenome')" oninput="setCustomValidity('')">
                                            </label>
                                        </div>
                                        <div class="col-4 initial">
